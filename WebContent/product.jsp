    ...
    while(rst.next()) {
        out.println("<div class='d-flex justify-content-between'>");
            ...
            out.println("<div>");
                ...
                out.println(
                    "<div>"+
                        "<a class='btn btn-warning mr-3' href='addcart.jsp?id="+rst.getInt(1)+"&brand="+rst.getString(4)+"&model="+rst.getString(7).replaceAll(" ","+")+"&price="+rst.getDouble(2)+"'>Add To Cart</a>"+
